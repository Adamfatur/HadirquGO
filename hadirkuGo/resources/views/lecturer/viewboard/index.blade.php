...
@section('content')
    <div class="container mt-5">
        ...
        <div class="d-flex justify-content-center mb-4 flex-wrap gap-2">
            <a href="{{ route('lecturer.viewboard.index') }}"
               class="btn btn-primary btn-hover-animate {{ request()->routeIs('lecturer.viewboard.index') ? 'active' : '' }}">
                Top Players
            </a>
        ...
        <div class="d-flex justify-content-center mb-4">
            <form method="GET" action="{{ route('lecturer.viewboard.index') }}" class="d-inline-block">
