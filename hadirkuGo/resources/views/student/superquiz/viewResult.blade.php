...
@section('title', 'Super Quiz Result')
@section('page-title', 'Super Quiz Result')
...
@section('content')
        ...
        <div class="container py-5">
            <div class="max-w-600 mx-auto">
                <div class="text-center mb-5 animate__animated animate__fadeInDown">
                    ...
                    <h3 class="display-5 fw-bold text-light mb-3">Super Quiz Result</h3> {{-- Ganti judul jadi Super Quiz Result --}}
                ...
                <div class="card shadow-lg border-0 rounded-3 animate__animated animate__zoomIn">
                    <div class="card-body p-4 p-md-5">
                        ...
                        <div class="progress-circle mx-auto mb-4" data-progress="{{ $correctAnswers * 10 }}">
                            <div class="progress-circle-inner">
                                <div class="progress-circle-number text-gradient-primary">
                                    {{ $correctAnswers * 10 }}<small>%</small>
                                </div>
                            </div>
                        </div>

                        <div class="text-center mb-4">
                            <h3 class="h2 fw-bold text-dark mb-2">{{ $correctAnswers }}/10 Correct Answers</h3> {{-- Update text to 10 questions --}}
                            <p class="text-muted mb-0">You answered {{ $correctAnswers }} questions correctly</p>

                            <div class="result-separator my-4">
                                <p class="text-muted mb-0">
                                    <span class="h5 fw-bold me-2 text-gradient-primary">Total Points:</span>
                                    <span class="h3">{{ $score }}</span> <small class="text-muted ms-2">/ 100</small> {{-- Update max points to 100 --}}
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-6 col-md-6">
                                <div class="stat-card bg-primary-soft text-primary p-3 rounded-3 d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="h5 fw-bold mb-1">{{ $correctAnswers }}</div>
                                        <small>Correct</small>
                                    </div>
                                </div>
                            </div>
                            <div class="col-6 col-md-6">
                                <div class="stat-card bg-danger-soft text-danger p-3 rounded-3 d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1">
                                        <div class="h5 fw-bold mb-1">{{ 10 - $correctAnswers }}</div> {{-- Update incorrect count to out of 10 --}}
                        ...
                        <div class="text-center mt-4">
                            <a href="{{ route('student.superquiz.index') }}" {{-- Update route to superquiz index --}}
                            class="btn btn-sm btn-primary rounded-pill px-5 py-3 shadow-sm hover-lift">
                                <i class="fas fa-arrow-left me-2"></i>
                                Back to Super Quiz Collection {{-- Update button text --}}
                            </a>
                        </div>
                    </div>
                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // data-progress berisi persentase
