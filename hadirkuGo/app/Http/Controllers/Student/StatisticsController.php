...
class StatisticsController extends Controller
{
    ...
    public function index()
    {
        ...
        if (!$statistics) {
            return view('student.statistics.index')->with('message', 'Statistics data is not available yet. Please check back later.');
        }
        ...
        return view('student.statistics.index', compact(
            'statistics',
