            ...
            <div class="max-w-600 mx-auto">
                ...
                <div class="card shadow-lg border-0 rounded-3 animate__animated animate__zoomIn">
                    <div class="card-body p-4 p-md-5">
                        ...
                        <!-- Progress Circle -->
                        <!-- data-progress menampilkan persentase (0-100), jadi correctCount * 20 karena 5 soal -->
                        ...
                        <div class="text-center mb-4">
                            ...
                            <div class="result-separator my-4">
                                <p class="text-muted mb-0">
                                    ...
                                    <!-- Ganti perhitungan poin:
                                         1 soal benar = 6 poin, max 5 soal = 30 poin -->
                        ...
                        <div class="text-center mt-4">
                            <a href="{{ route('lecturer.quizzes.index') }}"
