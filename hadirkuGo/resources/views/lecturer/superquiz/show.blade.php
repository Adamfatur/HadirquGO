        ...
        <div class="card border-0 shadow-lg rounded" style="border-radius: 0.75rem;">
            ...
            <div class="card-body p-4">
                ...
                <div class="d-flex justify-content-end">
                    <a href="{{ route('lecturer.superquiz.index') }}" class="btn btn-secondary me-2 rounded-pill px-4"> {{-- Route names diperbarui menjadi lecturer.superquiz.* --}}
                        <i class="fas fa-arrow-circle-left me-1"></i> Kembali ke Daftar Quiz
                    </a>
                    <a href="{{ route('lecturer.superquiz.question', [$superQuiz->unique_id, 1]) }}" class="btn btn-danger rounded-pill px-4"> {{-- Route names diperbarui menjadi lecturer.superquiz.* --}}
