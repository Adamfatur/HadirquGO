...
class QrCodeController extends Controller
{
    ...
    private function generateQrCode($type)
    {
        ...
        if ($existingToken) {
            ...
            $token = Str::random(64);
            $expiresAt = Carbon::now()->addSeconds(10); // Ubah durasi menjadi 10 detik
        ...
        $view = $type === 'checkin'
            ? 'lecturer.qrcode.checkin'
            : 'lecturer.qrcode.checkout';
    ...
    public function success()
    {
        ...
        return view('lecturer.attendance.success', compact('testimonies'));
    }
}
