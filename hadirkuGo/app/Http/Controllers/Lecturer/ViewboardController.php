...
class ViewboardController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('lecturer.viewboard.index', compact('rankings', 'period', 'activeTab'));
    }
    ...
    public function topSessions(Request $request)
    {
        ...
        $rankings = UserLeaderboard::with('user')
            ...
            ->get();
        return view('lecturer.viewboard.top_sessions', compact('rankings', 'period'));
    }
    ...
    public function topDuration(Request $request)
    {
        ...
        $rankings = UserLeaderboard::with('user')
            ...
            ->orderBy('current_rank', 'asc')
            ->get();
        return view('lecturer.viewboard.top_duration', compact('rankings', 'period'));
    }
    ...
    public function topLocations(Request $request)
    {
        ...
        $topLocations = LocationLeaderboard::with('attendanceLocation')
            ...
            ->orderBy('current_rank', 'asc')
            ->get();
        return view('lecturer.viewboard.top_locations', compact('topLocations', 'period'));
    }
    ...
    public function topPoints()
    {
        ...
        return view('lecturer.viewboard.top_points', compact('rankings', 'userRank'));
    }
    ...
    public function topLevels()
    {
        ...
        return view('lecturer.viewboard.top_levels', compact('rankings', 'userRank'));
    }
    ...
    public function topTeams(Request $request)
    {
        ...
        $teamRankings = TeamLeaderboard::with('team')
            ...
            ->orderBy('current_rank', 'asc')
            ->get();
        return view('lecturer.viewboard.top_teams', compact('teamRankings', 'period'));
    }
