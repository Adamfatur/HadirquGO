                ...
                <div class="col-6 d-flex">
                    <div class="card stat-card shadow border-0 flex-fill">
                        <div class="card-body text-center">
                            ...
                            <p class="card-text fs-5 text-dark">{{ $statistics->average_checkin_time ?? 'N/A' }}</p>
                        </div>
                    </div>
                </div>
                <div class="col-6 d-flex">
                    <div class="card stat-card shadow border-0 flex-fill">
                        <div class="card-body text-center">
                            ...
                            <p class="card-text fs-5 text-dark">{{ $statistics->average_checkout_time ?? 'N/A' }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-6 d-flex">
                    <div class="card stat-card shadow border-0 flex-fill">
                        <div class="card-body text-center">
                            ...
                            <p class="card-text fs-5 text-dark">{{ $mostFrequentLocation->name ?? 'N/A' }}</p>
                        </div>
                    </div>
                </div>
                <div class="col-6 d-flex">
                    <div class="card stat-card shadow border-0 flex-fill">
                        <div class="card-body text-center">
                            ...
                            <p class="card-text fs-5 text-dark">{{ $leastFrequentLocation->name ?? 'N/A' }}</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-4 d-flex">
                    <div class="card stat-card shadow border-0 flex-fill text-center">
                        <div class="card-body">
                            ...
                            <h6 class="card-title mt-3 text-muted">Check-ins</h6>
                            <p class="card-text fs-5 text-dark">{{ $statistics->total_checkins }}</p>
                        </div>
                    </div>
                </div>
                <div class="col-4 d-flex">
                    <div class="card stat-card shadow border-0 flex-fill text-center">
                        <div class="card-body">
                            ...
                            <h6 class="card-title mt-3 text-muted">Check-outs</h6>
                            <p class="card-text fs-5 text-dark">{{ $statistics->total_checkouts }}</p>
                        </div>
                    </div>
                </div>
                <div class="col-4 d-flex">
                    <div class="card stat-card shadow border-0 flex-fill text-center">
                        <div class="card-body">
                            ...
                            <p class="card-text fs-5 text-dark">{{ $statistics->total_attendance_sessions }}</p>
                        </div>
                    </div>
                </div>

                <!-- Streaks and Max Check-ins -->
                <div class="col-6 d-flex">
                    <div class="card stat-card shadow border-0 flex-fill text-center">
                        <div class="card-body">
                            <h6 class="card-title text-muted">{{ __('Longest Streak') }}</h6>
                            <p class="fs-5 text-dark">{{ $statistics->longest_consecutive_attendance_streak }} days</p>
                        </div>
                    </div>
                </div>
                <div class="col-6 d-flex">
                    <div class="card stat-card shadow border-0 flex-fill text-center">
                        <div class="card-body">
                            <h6 class="card-title text-muted">Max Check-ins</h6>
                            <p class="fs-5 text-dark">{{ $statistics->max_checkins_in_one_day }}</p>
                        </div>
                    </div>
                </div>
            </div>
