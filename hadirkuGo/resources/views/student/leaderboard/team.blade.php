@extends('layout.student') <!-- Layout for student -->
...
@section('content')
    <div class="container mt-5">
        ...
        <div class="d-grid gap-2 mb-4">
            <a href="{{ route('student.leaderboard.index') }}" class="btn btn-outline-light rounded-pill">Back to User Rankings</a>
            <a href="{{ route('student.dashboard') }}" class="btn btn-primary rounded-pill">{{ __('Back to Dashboard') }}</a>
        </div>
            ...
            <div class="text-center mt-5">
                <div class="card shadow-sm p-4" style="background-color: #f9f9fb; border-radius: 20px;">
                    <div class="d-flex flex-column align-items-center">
                        ...
                        <a href="{{ route('student.dashboard') }}" class="btn btn-primary mt-3">Go {{ __('Back to Dashboard') }}</a>
                    </div>
                </div>
            </div>
        @else
