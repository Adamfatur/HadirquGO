...
class ProfileController extends Controller
{
    public function show()
    {
        ...
        return view('student.profile.show', compact('user', 'profileData'));
    }
    ...
    public function updateBirthDate(Request $request)
    {
        ...
        // Redirect kembali ke halaman profil dengan pesan sukses
        return redirect()->route('student.profile.show')->with('success', 'Birth date updated successfully.');
    }
    ...
    public function updateName(Request $request)
    {
        ...
        if ($user->name_changed) {
            return redirect()->route('student.profile.show')->withErrors(['name' => 'Name can only be changed once.']);
        }
        ...
        return redirect()->route('student.profile.show')->with('success', 'Name updated successfully.');
    }
}
