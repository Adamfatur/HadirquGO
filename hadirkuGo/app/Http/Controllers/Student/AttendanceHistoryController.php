...
class AttendanceHistoryController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($attendances->isEmpty()) {
            ...
            return view('student.attendance_history.index', compact('attendances', 'lastAttendance'));
        }

        // If there's attendance, just return the regular view
        return view('student.attendance_history.index', compact('attendances'));
    }
    ...
    public function dailySummary()
    {
        ...
        return view('student.daily.daily_summary', compact(
            'weekData',
            'attendances',
            'totalLocations',
            'totalDuration',
