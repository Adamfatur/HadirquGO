...
class TestimonyController extends Controller
{
    ...
    public function success()
    {
        ...
        try {
            ...
            return view('student.attendance.success', [
                'rewards' => $rewards,
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('student.attendance.success')->with('success', 'Testimoni berhasil disimpan!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('student.attendance.success')->with('success', 'Testimonial updated successfully!');
    }
