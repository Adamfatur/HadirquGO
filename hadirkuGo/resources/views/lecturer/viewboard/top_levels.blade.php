                                ...
                                <tr class="border-bottom animate__animated animate__fadeIn {{ Auth::id() == $data->user_id ? 'table-primary' : '' }}">
                                    ...
                                    <td class="text-dark">
                                        @php
                                            ...
                                            $rankClass        = $rankStyle['class'];
                                            $glowClass        = $rankStyle['glow'];
                                            $titleBadgeStyle  = $rankStyle['badge'];
                                            $iconColor        = $rankStyle['iconColor'];
                                        @endphp
                                    ...
                                    <td>
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <span class="badge rounded-pill px-3 py-2 shadow-sm" style="background-color: {{ $style['bg'] }}; color: {{ $style['text'] }}; border: 1px solid {{ $style['border'] }}; font-weight: 600; font-size: 0.85rem;">
                                                {{ $data->level }} <span class="ms-1 opacity-75" style="font-size: 0.75rem;">(Level {{ RankHelper::getLevelNumber($data->user) }})</span>
                                            </span>
                                        </div>
                                    </td>
