                ...
                <div class="card shadow-lg border-0 rounded-3 animate__animated animate__zoomIn">
                    <div class="card-body p-4 p-md-5">
                        ...
                        <div class="d-grid gap-3 col-md-6 mx-auto mb-4">
                            <a href="{{ route('student.superquiz.question', ['superQuiz' => $superQuiz->unique_id, 'questionNumber' => $questionNumber + 1]) }}" {{-- Route next question diubah ke student --}}
                        ...
                        <div class="text-center mt-4">
                            <form action="{{ route('student.superquiz.surrenderQuiz', $superQuiz->unique_id) }}" method="POST"> {{-- Route surrender diubah ke student --}}
                                @csrf
