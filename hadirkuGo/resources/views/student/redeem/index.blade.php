                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    ...
                                    <span class="badge bg-secondary">
                                        <i class="fa-solid fa-boxes-stacked"></i> {{ $product->stock_quantity }}
                                    </span>
                                </div>
                            ...
                            <div class="modal-content rounded-4 border-0 shadow">
                                ...
                                <div class="modal-body p-3">
                                    ...
                                    <div class="row g-2">
                                        ...
                                        <div class="col-6">
                                            <div class="p-2 bg-light rounded-3">
                                                <h6 class="small text-muted mb-1">
                                                    <i class="fa-solid fa-coins me-1"></i> Points
                                                </h6>
                                ...
                                <div class="modal-footer border-0 p-3">
                                    ...
                                    @if(!$existingRequest || ($existingRequest && $existingRequest->status === 'rejected') || ($existingRequest && $existingRequest->status === 'approved'))
                                        <button type="button" class="btn btn-success w-100 rounded-pill py-2 shadow-sm" data-bs-toggle="modal" data-bs-target="#confirmRedeemModal" data-product-id="{{ $product->id }}" data-product-name="{{ $product->name }}" data-product-points="{{ $product->points_required }}" data-redeem-url="{{ route('student.redeem.store', $product->product_code) }}">
