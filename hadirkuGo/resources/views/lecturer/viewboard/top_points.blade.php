    ...
    <div class="container mt-5">
        <div class="text-center mb-5">
            <h2 class="fw-bold text-white" style="font-size: 1.5rem;">
                🏆 Top 50 Rankings by Points 🏆
            </h2>
            <p class="text-light" style="font-size: 1rem; margin-top: -5px;">
                Check your performance and rankings based on <strong>total points</strong>!
            </p>
        </div>
        ...
        @if(isset($userRank))
            <div class="card shadow-sm border-0 mb-4 animate__animated animate__pulse" style="border-radius: 15px; background: linear-gradient(135deg, #f59e0b 0%, #d97706 100%); color: white;">
                    ...
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center">
                            <div class="position-relative me-3">
                                ...
                                <span class="position-absolute bottom-0 end-0 badge rounded-pill bg-dark text-white" style="font-size: 0.7rem;">YOU</span>
                            </div>
                            <div>
                                <h5 class="fw-bold mb-1">{{ __('Your Point Ranking') }}</h5>
                    ...
                    @if(isset($userRank->is_outside))
                        <div class="mt-3 p-3 rounded-3" style="background: rgba(255,255,255,0.1); border: 1px dashed rgba(255,255,255,0.3);">
                            <p class="mb-0 small italic text-center">
                                ...
                                "Semangat terus! Konsistensi adalah kunci. Kumpulkan lebih banyak poin setiap harinya untuk meroket ke Top 50!"
                            </p>
                        </div>
                    @endif
                </div>
        ...
        <div class="card shadow-sm p-4 mb-5 animate__animated animate__fadeIn" style="border-radius: 20px; background-color: #f9f9fb;">
            <div class="card-header bg-transparent border-0 d-flex justify-content-between align-items-center">
                <h2 class="mb-0 text-secondary font-weight-bold" style="color: #1e3a8a;">
                    Top 50 Rankings by Points (All Time)
                </h2>
                <small class="text-muted">{{ __('Updated hourly') }}</small>
            </div>
            <div class="card-body">
                @include('partials.leaderboard_search', ['searchCategory' => 'top_points'])
                @if($rankings->isEmpty())
                            ...
                            @foreach($rankings as $data)
                                <tr class="border-bottom animate__animated animate__fadeIn {{ Auth::id() == $data->user_id ? 'table-primary' : '' }}">
                                    ...
                                    <td class="text-dark">
                                        ...
                                        <a href="{{ route('lecturer.evaluation.show', ['member_id' => $data->user->member_id]) }}" class="text-decoration-none text-dark d-flex align-items-center" style="transition: transform 0.2s ease;" onmouseover="this.style.transform='scale(1.03)'" onmouseout="this.style.transform='scale(1)'">
                                        @else
                                        <div class="d-flex align-items-center">
                                        @endif
                                            <div class="position-relative me-3">
                                            ...
                                            <div>
                                                ...
                                                @if($data->title)
                                                    <div class="small mt-1 px-2 py-1 rounded-pill" style="font-size: 0.75rem; display: inline-flex; align-items: center; {{ $titleBadgeStyle }}">
                                    ...
                                    <td class="fw-bold text-warning" style="font-size: 1.1rem;">
