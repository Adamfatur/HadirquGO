...
<head>
    ...
    <title>QR Code Scanner - HadirkuGO</title>
...
<script>
    ...
    function processAttendance(qrCodeMessage) {
        ...
        const endpoint = `/api/scanner/{{ $location->id }}/process`;
        const requestData = {
        ...
        fetch(endpoint, {
            ...
            .then(data => {
                ...
                if (data.status === "checked_in") {
                    ...
                    modalMessage.textContent = `Welcome, ${data.user_name}! ${data.message}`;
                } else if (data.status === "checked_out") {
                    modalIcon.classList.add("success", "fas", "fa-check-circle");
                    modalMessage.textContent = `Goodbye, ${data.user_name}! ${data.message}`;
                } else {
