...
@section('content')
    ...
    <div class="container py-4">
        ...
        <div class="mb-5">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="card shadow-sm border-0 h-100">
                        <div class="card-body text-center p-4 position-relative">
                            <h5 class="fw-bold text-warning">Mission: Daily MP
                                <button type="button" class="btn btn-sm btn-link p-0" data-bs-toggle="modal" data-bs-target="#missionInfoModal" onclick="showMissionInfo(1)">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="card shadow-sm border-0 h-100">
                        <div class="card-body text-center p-4 position-relative">
                            <h5 class="fw-bold text-primary">Mission: Longest Activity
                                <button type="button" class="btn btn-sm btn-link p-0" data-bs-toggle="modal" data-bs-target="#missionInfoModal" onclick="showMissionInfo(2)">
                                    <i class="fas fa-info-circle"></i>
                                </button>
                            </h5>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    <div class="card shadow-sm border-0 h-100">
                        <div class="card-body text-center p-4 position-relative">
                            <h5 class="fw-bold text-warning">Mission: Visit 5+ Locations
                                <button type="button" class="btn btn-sm btn-link p-0" data-bs-toggle="modal" data-bs-target="#missionInfoModal" onclick="showMissionInfo(3)">
                                    <i class="fas fa-info-circle"></i>
                                </button>
                            </h5>
                            ...
                            @if($dailyMissionStatus['visitLocations']['isAchieved'])
                                <i class="fas fa-check-circle fa-3x text-success mb-3"></i>
                                <h6 class="text-success">{{ $dailyMissionStatus['visitLocations']['locationsVisited'] }}/5</h6>
                                <p class="text-muted">Congratulations! You've visited 4+ locations today.</p>
        ...
        <!-- Mission Info Modal -->
        <div class="modal fade" id="missionInfoModal" tabindex="-1" aria-labelledby="missionInfoModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content" style="background-color: #1c2541; color: #e0e0e0; border-radius: 15px;">
                    <div class="modal-header" style="border-bottom: 1px solid #576f91;">
                        <h5 class="modal-title" id="missionInfoModalLabel">Mission Information</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" style="filter: invert(1);"></button>
                    </div>
                    <div class="modal-body">
                        <p id="missionInfoContent"></p>
                    </div>
                    <div class="modal-footer" style="border-top: 1px solid #576f91;">
                        <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">Close</button>
                    </div>
        ...
        <script>
            ...
            function showAchievementDetails(achievementId) {
                ...
                fetch(`/student/achievements/${achievementId}/details`)
            ...
            function showMissionInfo(missionId) {
                const missionInfoContent = document.getElementById('missionInfoContent');
                const missionInfoModalLabel = document.getElementById('missionInfoModalLabel');
                ...
                switch (missionId) {
                    case 1:
                        missionTitle = 'Mission: Daily MP';
                        missionDetails = 'Be the first to check in on the day to earn this badge. Applies across all teams.';
                        break;
                    case 2:
                        missionTitle = 'Mission: Longest Activity';
                        missionDetails = 'Spend the longest time in activities today to earn this badge. At least 2 people must have checked in for the mission to be valid.';
                        break;
                    case 3:
                        missionTitle = 'Mission: Explorer';
                        missionDetails = 'Visit more than 5 different locations today to earn this badge. No minimum time required at each location.';
                        break;
                    default:
                        missionTitle = 'Mission Information';
                        missionDetails = 'No details available for this mission.';
                }

                missionInfoModalLabel.innerText = missionTitle;
                missionInfoContent.innerText = missionDetails;
            }
        </script>
@endsection